...
namespace IIS.AliDent
{
    ...
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AliDent.Единицы fЕдиницы;
        
        private IIS.AliDent.Материал fМатериал;
        ...
        public virtual IIS.AliDent.Единицы Единицы
        {
            get
            {
                ...
                IIS.AliDent.Единицы result = this.fЕдиницы;
        ...
        [PropertyStorage(new string[] {
                "Материал"})]
        [NotNull()]
        public virtual IIS.AliDent.Материал Материал
        {
            get
            {
                ...
                IIS.AliDent.Материал result = this.fМатериал;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.AliDent.Услуга.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.AliDent.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.AliDent.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.AliDent.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.AliDent.Услуга fУслуга) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fУслуга)))
        {
        }
        
        public IIS.AliDent.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.AliDent.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.AliDent.СоставУслуги dataobject)
        {
