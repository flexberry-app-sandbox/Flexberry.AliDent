...
namespace IIS.AliDent
{
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AliDent.ТипОплаты fТипОплаты;
        
        private IIS.AliDent.Кабинет fКабинет;
        
        private IIS.AliDent.Клиент fКлиент;
        
        private IIS.AliDent.Сотрудник fСотрудник;
        
        private IIS.AliDent.DetailArrayOfОказаниеУслуг fОказаниеУслуг;
        ...
        public virtual IIS.AliDent.ТипОплаты ТипОплаты
        {
            get
            {
                ...
                IIS.AliDent.ТипОплаты result = this.fТипОплаты;
        ...
        [PropertyStorage(new string[] {
                "Кабинет"})]
        [NotNull()]
        public virtual IIS.AliDent.Кабинет Кабинет
        {
            get
            {
                ...
                IIS.AliDent.Кабинет result = this.fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.AliDent.Клиент Клиент
        {
            get
            {
                ...
                IIS.AliDent.Клиент result = this.fКлиент;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.AliDent.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.AliDent.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.AliDent.DetailArrayOfОказаниеУслуг ОказаниеУслуг
        {
            get
            {
                ...
                {
                    this.fОказаниеУслуг = new IIS.AliDent.DetailArrayOfОказаниеУслуг(this);
                }
                IIS.AliDent.DetailArrayOfОказаниеУслуг result = this.fОказаниеУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.AliDent.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.AliDent.Запись));
                }
            }
        }
    }
