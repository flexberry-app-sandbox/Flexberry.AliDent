...
namespace IIS.AliDent
{
    ...
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AliDent.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        public virtual IIS.AliDent.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.AliDent.DetailArrayOfСоставУслуги(this);
                }
                IIS.AliDent.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УслугаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаE", typeof(IIS.AliDent.Услуга));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаL", typeof(IIS.AliDent.Услуга));
                }
            }
        }
    }
