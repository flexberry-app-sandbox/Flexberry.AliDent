...
namespace IIS.AliDent
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AliDent.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.AliDent.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.AliDent.DetailArrayOfДокументы(this);
                }
                IIS.AliDent.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.AliDent.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.AliDent.Клиент));
                }
            }
        }
    }
