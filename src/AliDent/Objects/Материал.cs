...
namespace IIS.AliDent
{
    ...
    public class Материал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AliDent.Производитель fПроизводитель;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.AliDent.Производитель Производитель
        {
            get
            {
                ...
                IIS.AliDent.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалE", typeof(IIS.AliDent.Материал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалL", typeof(IIS.AliDent.Материал));
                }
            }
        }
    }
