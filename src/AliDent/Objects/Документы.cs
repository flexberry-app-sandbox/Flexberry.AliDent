...
namespace IIS.AliDent
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.AliDent.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.AliDent.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.AliDent.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.AliDent.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.AliDent.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.AliDent.Документы this[int index]
        {
            get
            {
                return ((IIS.AliDent.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.AliDent.Документы dataobject)
        {
